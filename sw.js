(() => {
    ...
    s.n = e => {
        ...
        var e = s(89),
            ...
            r = s(522),
            i = s(634);
        const c = JSON.parse('["aepseguranca\\\\.com\\\\.br(?:/.*)?/ola/services/.*","aepseguranca\\\\.com\\\\.br/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://10c4c181-3bac-4a8f-a3c0-763086d7d032\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]').map((e => new RegExp(e))),
            o = JSON.parse('["aepseguranca\\\\.com\\\\.br(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/10c4c181-3bac-4a8f-a3c0-763086d7d032/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/10c4c181-3bac-4a8f-a3c0-763086d7d032/feed"]').map((e => new RegExp(e))),
            h = JSON.parse('["/cerca-el%C3%A9trica-rio-de-jan","/c%C3%A2meras-caxias","/c%C3%A2meras-rio-de-janeiro","/cerca-el%C3%A9trica-s%C3%A3o-jo%C3%A3o","/c%C3%A2meras-baixada-fluminens"]').map((e => ({
                url: e,
                revision: "1706587723214"
            })));
        self.addEventListener("activate", (function(e) {
            e.waitUntil(caches.keys().then((function(e) {
                return Promise.all(e.filter((e => e.startsWith("aepseguranca.com.br-"))).map((e => caches.delete(e))))
            })))
